...
// in simulator we redefine to format for Poelsevognen Developer console
...
{\
	NSString * exceptionName = [@"org.poelsevognen." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.poelsevognen";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIPoelsevognenNativeItemNone = -1, 
	UIPoelsevognenNativeItemSpinner = -2,
	UIPoelsevognenNativeItemProgressBar = -3,
	
	UIPoelsevognenNativeItemSlider = -4,
	UIPoelsevognenNativeItemSwitch = -5,
	UIPoelsevognenNativeItemMultiButton = -6,
	UIPoelsevognenNativeItemSegmented = -7,
	
	UIPoelsevognenNativeItemTextView = -8,
	UIPoelsevognenNativeItemTextField = -9,
	UIPoelsevognenNativeItemSearchBar = -10,
	
	UIPoelsevognenNativeItemPicker = -11,
	UIPoelsevognenNativeItemDatePicker = -12,
	
	UIPoelsevognenNativeItemInfoLight = -13,
	UIPoelsevognenNativeItemInfoDark = -14,
	
	UIPoelsevognenNativeItemDisclosure = -15,
	
	UIPoelsevognenNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Poelsevognen instances of
