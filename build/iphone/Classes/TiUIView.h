...
/**
 Base class for all Poelsevognen views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Poelsevognen view hierarchy (such as wrapped iOS UIViews) was touched.
