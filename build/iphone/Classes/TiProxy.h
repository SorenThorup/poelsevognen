...
//Rare exceptions to indicate a bug in the _poelsevognen code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Poelsevognen proxies.
 */
