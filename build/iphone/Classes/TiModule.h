...
/**
 The base class for all Poelsevognen modules
 */
...
/**
 Poelsevognen Platform calls this method on startup.
 */
-(void)startup;

/**
 Poelsevognen Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Poelsevognen Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Poelsevognen Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Poelsevognen Platform calls this method on resume.
 @param sender The sender of the event.
 */
