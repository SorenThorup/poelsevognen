...
//@interface PoelsevognenObject : NSObject
//@end

@interface PoelsevognenObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[PoelsevognenObject class]])
		{
			for (NSString *key in [[(PoelsevognenObject*)o modules] allKeys])
			{
