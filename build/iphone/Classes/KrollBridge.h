...
@interface PoelsevognenObject : KrollCoverageObject {
#else
@interface PoelsevognenObject : KrollObject {
#endif
@private
...
extern NSString * Poelsevognen$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	PoelsevognenObject *_poelsevognen;
    KrollObject* console;
	BOOL shutdown;
